...
game.import("character", function () {
	...
	//for (const name in xingfanCharacter.character) {//记得这里也要改
	//	const info = xingfanCharacter.character[name];//记得这里也要改
